...
using GillyTracker.AppHost;
using GillyTracker.Core;

namespace GillyTracker.AppHost;

public static class Resources
{
    public const string ContainerSuffixKey = "GillyTracker:ContainerSuffix";
    public const string Frontend = "GillyTracker-frontend";
    public const string SqlServer = "GillyTracker-sql";
    ...
    extension(IDistributedApplicationBuilder builder)
    {
        ...
        {
            return builder.AddAzureSqlServer("GillyTracker-sql");
        }
        ...
        public IResourceBuilder<SqlServerServerResource> AddSqlServer()
        {
            ...
            string? containerName = string.IsNullOrWhiteSpace(containerSuffix) ? "GillyTracker-sql" : $"GillyTracker-{containerSuffix}-sql";
            
            return builder
                .AddSqlServer(SqlServer)
                .WithLifetime(ContainerLifetime.Persistent)
                .WithContainerName(containerName)
                .WithDataVolume("GillyTracker-database")
...
#pragma warning restore ASPIREINTERACTION001 // Type is for evaluation purposes only and is subject to change or removal in future updates. Suppress this diagnostic to proceed.
                ProcessStartInfo psi = new()
                {
                    ...
                    ArgumentList = {
                        ...
                        "--no-build",
                        "--project",
                        "GillyTracker.UITests\\GillyTracker.UITests.csproj"
                    },
    ...
    extension(IResourceBuilder<SqlServerServerResource> sql)
    {
        ...
        {
            var database = sql.AddDatabase("GillyTracker-db");
