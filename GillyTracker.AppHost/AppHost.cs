...
builder.AddAzureContainerAppEnvironment("GillyTracker-cae");
...
{
    db = builder.AddAzureSqlServer().AddDatabase("GillyTracker-db");
}
else
{
    ...
    var dbGate = builder.AddContainer("dbgate", "dbgate/dbgate")
        ...
        .WithContainerName("GillyTracker-db-gate")
...
var backend = builder.AddProject<Projects.GillyTracker>("GillyTracker-backend")
...
var frontendApp = builder.AddJavaScriptApp(Resources.Frontend, "../GillyTracker.Web", "dev")
    .WithPnpm()
